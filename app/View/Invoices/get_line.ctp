<?php if(isset($service)){ ?>
	...
	<td><input type="number" name="data[Line][<?php echo $index; ?>][amount_hours]" class="aHours" min="0" max="9999999999" value="0.00"></td>
	<td><input type="number" name="data[Line][<?php echo $index; ?>][rate]" class="rate" min="0" max="9999999999" value="<?php echo h($service['Service']['rate']); ?>"></td>
	<td>
...
<?php } else if(isset($product)) { ?>
	...
	<td><input type="number" name="data[Line][<?php echo $index; ?>][amount_hours]" class="aHours" min="0" max="9999999999" value="1.00"></td>
	<td><input type="number" name="data[Line][<?php echo $index; ?>][rate]" class="rate" min="0" max="9999999999" value="<?php echo h($product['Product']['unit_price']); ?>"></td>
	<td>
		<select name="data[Line][<?php echo $index; ?>][tax_id]" class="tax" style="margin: 0px;">
			<?php foreach($taxes as $tax): ?>
